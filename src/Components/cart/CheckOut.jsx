...
//       // The Razorpay order ID is in response.data.order.id, and saved order ID is in response.data.id
//       const { order, id: savedOrderId } = response.data;

//       setOrderId(savedOrderId); // Store the saved order ID for later use
...
//         image: logo,
//         order_id: order.id, // Corrected to access the Razorpay order ID
//         handler: async function (response) {
//           // Handle the payment success response
//           const { razorpay_order_id, razorpay_payment_id, razorpay_signature } = response;
//           try {
//             // Verify the payment by sending the details to the backend
//             const verifyResponse = await axios.post(`${URL}/verify/${id}`, {
//               razorpay_order_id,
//               razorpay_payment_id,
//               razorpay_signature,
//               order_id: savedOrderId, // Using the saved order ID from the backend response
//             });
//             console.log("Payment Verification Response:", verifyResponse.data);
//             Swal.fire({
//               title: "Are you sure?",
//               text: "You are ordering ",
//               icon: "info",
//               showCancelButton: true,
//               confirmButtonColoar: "#3085d6",
