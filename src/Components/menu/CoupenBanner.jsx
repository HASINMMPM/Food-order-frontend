                ...
                <div className="flex flex-col justify-between items-start px-6 gap-2">
                  <div className="flex flex-col items-start py-14  gap-4 justify-center">
                    <h1 className="text-lg md:text-xl font-semibold">
                      ...
                      <span className="px-2 bg-secondary text-primary text-2xl md:text-3xl font-bold">
                        {coupon.discount}% OFF
                      </span>
                      <br />
                    ...
                    <p className="text-sm md:text-lg italic">
                      Hurry! This offer won't last long. Enjoy delicious savings
                      today!
                    </p>
                  </div>
                  <div
                    onClick={() => copyToClipboard(coupon.code)}
                    className="cursor-pointer flex justify-center items-center gap-2 hover:bg-black duration-300 bg-secondary text-primary p-3 rounded-xl hover:text-secondary text-lg mx-2"
                  >
                    Copy Code
                    <FaCopy className="" />
                  </div>
